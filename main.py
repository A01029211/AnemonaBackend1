...
from routes.plantillas import router as plantillas
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://10.22.151.18:3000", "http://127.0.0.1:8000", 
